...
namespace Maps
{
    internal static class SecondSurvey
    {
        ...
        private static readonly AllegianceDictionary s_t5Allegiances = new AllegianceDictionary {
            ...
            { "3EoG", "Ga", null, "Third Empire of Gashikan" },
            { "4Wor", "Fw", null, "Four Worlds" },
            ...
            { "HaCo", "Hc", null, "Haladon Cooperative" },
            { "HoPA", "Ho", null, "Hochiken People's Assembly" },
            { "HvFd", "Hv", "Hv", "Hive Federation" },
            ...
            { "MnPr", "Mn", null, "Mnemosyne Principality" },
            ...
            { "Prot", "Pt", null, "The Protectorate" },
            { "RaRa", "Ra", null, "Ral Ranta" },
            { "Reac", "Rh", null, "The Reach" },
            { "ReUn", "Re", null, "Renkard Union" },
            { "SaCo", "Sc", null, "Salinaikin Concordance" },
            { "Sark", "Sc", null, "Sarkan Constellation" },
            ...
            { "VDeG", "Vd", "Va", "Democracy of Greats" },
            { "VDrN", "VN", "Va", "Drr'lana Network" },
            { "VDzF", "Vf", "Va", "Dzarrgh Federate" },
            { "VFFD", "V1", "Va", "First Fleet of Dzo" },
            { "VGoT", "Vg", "Va", "Glory of Taarskoerzn" },
            { "ViCo", "Vi", "Va", "Viyard Concourse" },
