...
function temp2color(kelvin) {
  function fit(a, b, c, x) {
    return Math.floor(a + b * x + c * Math.log(x));
  }
  let r, g, b;
  ...
  if (kelvin < 6600)
    ...
    r =
        fit(351.97690566805693, 0.114206453784165, -40.25366309332127,
            (kelvin / 100) - 55);
  ...
  if (kelvin <= 1000)
    ...
    g =
        fit(-155.25485562709179, -0.44596950469579133, 104.49216199393888,
            (kelvin / 100) - 2);
  else
    g =
        fit(325.4494125711974, 0.07943456536662342, -28.0852963507957,
            (kelvin / 100) - 50);
  ...
  if (kelvin <= 2000)
    ...
    b =
        fit(-254.76935184120902, 0.8274096064007395, 115.67994401066147,
            (kelvin / 100) - 10);
  else
    b = 255;
